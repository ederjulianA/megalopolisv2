...
--
-- Servidor: localhost
-- Tiempo de generación: 10-06-2014 a las 03:29:41
...
(48, 50, 6, 70000, 57, '2014-06-08', '2014-06-08'),
...
CREATE TABLE IF NOT EXISTS `categorias` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `preguntas` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=31 ;
...
(28, 1, 11, 'camiseta colombia', 'Adidas  traen para ti la nueva camiseta de la Selección Colombia De Futbol para que vivas la pasión de este deporte con orgullo. Pronto llegará e', 'img/products/2014-05-20-17-WAaJ4zGeajj0W-colombia.jpg', NULL, NULL, NULL, NULL, 1, '2014-05-20', '2014-05-20'),
...
(45, 1, 11, 'CAMISETAS ORIGINALES ITALIA MUNDIAL 2014', 'DISPONIBLE LAS TALLAS  S, M, L Y XL -  MANGA CORTA  \r\nTODAS LAS CAMISETAS VIENE EN SU RESPECTIVA BOLSA ORIGINAL', 'img/products/2014-06-05-12-x1cmXWkGK6P9I-italia2014.jpg', NULL, NULL, NULL, 'img/products/img-lista/2014-06-05-12-x1cmXWkGK6P9I-italia2014.jpg', 1, '2014-06-05', '2014-06-05'),
...
(48, 1, 11, 'Camisetas Hombre, Mujer Y Niño Selección Colo', 'camiseta de la seleccion colombia manga larga ', 'img/products/2014-06-05-17-X2ERF5LPHMMn7-colombia-larga.jpg', NULL, NULL, NULL, 'img/products/img-lista/2014-06-05-17-X2ERF5LPHMMn7-colombia-larga.jpg', 1, '2014-06-05', '2014-06-05'),
...
(50, 1, 11, 'Camiseta Del Real Madrid 2014 Con Nombre, Marcadas, Ronaldo.', 'Sistema ClimaCool.\r\nTodas las tallas disponibles.\r\nCamiseta marcada o no, como la desee.', 'img/products/2014-06-08-22-KRJVDmT1xWgiq-madrid2.jpg', 'img/products/img-lista/madrid-back.jpg', 'img/products/img-lista/madrid-front.jpg', 'img/products/img-lista/madird-sola.jpg', 'img/products/img-lista/2014-06-08-22-KRJVDmT1xWgiq-madrid2.jpg', 1, '2014-06-08', '2014-06-08'),
(52, 1, 11, 'Prueba resize', 'prueba resize', 'img/products/2014-06-08-23-bOUxUIeapjiKd-dep2.jpg', NULL, NULL, NULL, 'img/products/img-lista/2014-06-08-23-bOUxUIeapjiKd-dep2.jpg', 1, '2014-06-08', '2014-06-08');
...
CREATE TABLE IF NOT EXISTS `promociones` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=14 ;
...
CREATE TABLE IF NOT EXISTS `sedes` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=17 ;
...
CREATE TABLE IF NOT EXISTS `subcategorias` (
  ...
  UNIQUE KEY `id_2` (`id`),
  KEY `id` (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=12 ;
...
CREATE TABLE IF NOT EXISTS `user_favoritos` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=154 ;
...
CREATE TABLE IF NOT EXISTS `user_subs` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=36 ;

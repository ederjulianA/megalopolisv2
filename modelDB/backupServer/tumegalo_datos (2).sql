...
--
-- Servidor: localhost
-- Tiempo de generación: 23-08-2014 a las 22:27:12
...
(154, 159, 35, 450000, 3, '2014-08-23', '2014-08-23');
...
(3, 'Restaurantes y comidas', '0000-00-00', '2014-08-19'),
...
CREATE TABLE IF NOT EXISTS `compra` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=27 ;
...
(26, 29, 30, 106, '1', '440000', '0', '440000', 0, '2014-08-23', '2014-08-23');
...
(36, 52, 0, 2, 0, 'Gorra Ripley LTDA', 'Gorras-Ripley', '', 'Somos una empresa dedicada a comercializar gorras juveniles de todos los estilos, de diferentes marcas.', 'Carrera 21 # 21-45', '6481166', 'img/empresas/2014-08-05-20-08-22-YP7xLU7KoYEJ1-logo-Gorras-Ripley.jpg', 'img/empresas/banners2014-08-19-22-08-12-Nu98fW34jVG7l-banner-Gorras-Ripley.jpg', 1, '2014-08-06 01:28:22', '2014-08-20 03:34:12', NULL, NULL),
...
(47, 61, 0, 2, 0, 'BELCO S.A.S', 'BELCO', '', 'Venta y Distribución de productos de belleza, tales como alfaparf milano, Recamier,Igora Royal , Lemar, Maxibel,Masglo, entre otros ', 'CARRERA 33 # 41-10', '3214286967- 300', 'img/empresas/2014-08-16-20-08-55-HNOJvPCqM7yJF-logo-BELCO.jpg', 'img/empresas/banners2014-08-16-20-08-18-pnJz5KqdQQk6u-banner-BELCO.jpg', 1, '2014-08-17 01:26:28', '2014-08-17 01:31:18', NULL, NULL),
(48, 62, 0, 2, 0, 'Zona Biker cascos & accesorios', 'Zona-Biker', '', 'Somos una empresa dedicada a la comercializacion de cascos y accesorios para motociclistas.', 'Carrera 21 # 41-39', '6705857', 'img/empresas/2014-08-19-15-08-19-gDlsY5dG6DubE-logo-Zona-Biker.jpg', 'img/empresas/banners2014-08-19-15-08-20-JZteCtwphW0nI-banner-Zona-Biker.jpg', 1, '2014-08-19 20:13:19', '2014-08-19 20:22:21', NULL, NULL);
...
(3, 33, 2, 'Eder Julian', 'Alvarez carrero', 'cerca a la iglesia de san francisco ', 'Carrera 24 # 18-76', 'San francisco', '3013119198', '2014-08-22', '2014-08-22'),
...
CREATE TABLE IF NOT EXISTS `preguntas` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=61 ;
...
(59, 29, 30, 106, 'asdnkjansddf', NULL, 0, '2014-08-23', '2014-08-23'),
(60, 29, 30, 67, 'esta disponible en talla 20', NULL, 0, '2014-08-23', '2014-08-23');
...
(86, 2, 4, 'TRATAMIENTO DE REDUCCIÓN DE MEDIDAS', 'Limpieza y exfoliación del area a tratar, aplicación de producto reductor, manta térmica, masaje, vacumterápia,, o gimnasia pasiva, o cavitación,, o mesoterápia con ultrasonido. asesoramiento para reforzar en casa, asesoramiento nutricional.', 'img/products/2014-08-05-02-08-41-YtCkgVUnfX0Vy-', NULL, NULL, NULL, NULL, 0, '2014-08-05', '2014-08-16'),
...
(138, 2, 4, 'ESMALTE MASGLO', 'Esmaltes de una excelente calidad con diversas tonalidades. ', 'img/products/2014-08-16-20-08-01-TrtJ3LBIOGb0y-', NULL, NULL, NULL, NULL, 1, '2014-08-16', '2014-08-19'),
(139, 1, 11, 'AGV K3 46 LG', 'El K-3 es uno de los clásicos más vendidos cascos de AGV. Su diseño deriva de la parte superior de la gama GP-Tech cascos, con lo que la mayoría de las últimas características avanzadas para este producto con un precio razonable. El casco de inspiración-line carrera maximiza el flujo de aire minimizando los niveles de ruido, mientras que el alerón de nuevo asegura la estabilidad a altas velocidades. El sistema de ventilación dispone de tres tomas frontales, y seis extractores posteriores y laterales, mientras que un protector de viento barbilla evitar turbulencias en el interior del casco.\r\n\r\nEl K-3 está disponible en una increíble gama de colores , incluyendo los gráficos oficiales Valentino Rossi réplica , que se pueden personalizar con adicionales Viseras , en Polarizados , Iridium y arco iris de colores.\r\n\r\nSi usted desea actualizar a una más ligera y más resistente de fibra de vidrio cubierta exterior del K-4 EVO sería el yelmo de la elección.', 'img/products/2014-08-19-15-08-31-LWB8lsoWvqyZV-', 'img/products/img-lista/2014-08-19-15-08-31-HiChFVsnx3XSw-', 'img/products/img-lista/2014-08-19-15-08-31-rmPeh9utP6i0i-', NULL, NULL, 1, '2014-08-19', '2014-08-19'),
(140, 2, 3, 'KERATINA LISSTYLE ', 'KIT LISSTYLE   Tratamiento alisador progresivo sin formol a base de KERATINA y CARBOCISTEINA, conocida por mantener la producción del colágeno. Actúa en la superficie de la cutícula capilar ELIMINANDO EL FRIZZ Y EL VOLUMEN.\r\n           ', 'img/products/2014-08-19-20-08-37-Pwn4R3uCFXnO3-', 'img/products/img-lista/2014-08-19-20-08-37-HPZGoIDbczg2p-', NULL, NULL, NULL, 1, '2014-08-19', '2014-08-20'),
(141, 2, 3, 'MASCARILLA CAPILAR INTENSIVA ARGAN', 'La Mascarilla Hidratante Intensiva de L´mar es un Tratamiento EXTRA ACONDICIONADOR enriquecido con ARGAN EXTRA VIRGEN que hidrata, acondiciona profundamente y repara el cabello seco, maltratado y dañado inclusive por procesos químicos.', 'img/products/2014-08-19-21-08-45-vg6fMS59LvU1Q-', 'img/products/img-lista/2014-08-19-21-08-45-TY3gH0M4jC662-', NULL, NULL, NULL, 1, '2014-08-19', '2014-08-19'),
(142, 2, 3, 'CREMA PARA PEINAR ARGAN', 'CREMA PARA PEINAR TRATAMIENTO CAPILAR RESTRUCTURANTE ARGAN', 'img/products/2014-08-19-21-08-20-MhQJfCa8uQFxJ-', 'img/products/img-lista/2014-08-19-21-08-20-oOtW13XgIsuGU-', NULL, NULL, NULL, 1, '2014-08-19', '2014-08-19'),
(143, 2, 3, 'SHAMPOO CON CERAMIDAS Y EXTRACTOS NATURALES', ' Shampoos con Extractos Naturales de L´mar con PH balanceado, acondicionan y son ideales para el cuidado diario del cabello pues contienen la riqueza nutritiva de las plantas que ayudan a recuperar las propiedades naturales del cabello.', 'img/products/2014-08-19-22-08-14-oZ2ZvlIwc1kHL-', NULL, NULL, NULL, NULL, 1, '2014-08-19', '2014-08-19'),
(144, 2, 3, 'KERATIN REPAIR PLUS', 'Tratamiento capilar reestructuraste con keratina y arginina proporcionando Nutrición,reparación,fortaleza y brillo  ', 'img/products/2014-08-19-22-08-00-wtnkW8h76VmI4-', NULL, NULL, NULL, NULL, 1, '2014-08-19', '2014-08-19'),
(145, 2, 3, 'KERATIN REPAIR PLUS', 'Tratamiento capilar reestructuraste con keratina y arginina proporcionando Nutrición,reparación,fortaleza y brillo  ', 'img/products/2014-08-19-22-08-08-vjzO7CdXCIiNu-', NULL, NULL, NULL, NULL, 1, '2014-08-19', '2014-08-19'),
(146, 2, 3, 'KERATIN REPAIR', 'Activa la producción de keratina, conservando la hidratación interna del cabello, desenredándolo fácilmente y recuperando el cuerpo, la suavidad, el brillo y la vitalidad. NO NECESITA ENJUAGUE, ÚNICA CON PROTECCIÓN SOLAR (FILTRO UV)\r\n', 'img/products/2014-08-19-22-08-16-pl8IAfO0FX3i3-', NULL, NULL, NULL, NULL, 1, '2014-08-19', '2014-08-19'),
(147, 2, 3, 'COCKTAIL REPOLARIZADORA', 'Tratamiento capilar intensivo, reparador y reestructurado ', 'img/products/2014-08-19-22-08-21-hxJ2yiLwGrG9v-', NULL, NULL, NULL, NULL, 1, '2014-08-19', '2014-08-19'),
(148, 2, 3, 'TRATAMIENTO SEMILLAS DE LINO', 'El Tratamiento Capilar Texturizante con Semillas de Lino L´MAR Nutre, Hidrata, Restaura y Revitaliza el cabello.  contienen Ácido Linoleico y Vitamina E que devuelven la belleza al cabello tinturado y frágil.', 'img/products/2014-08-20-00-08-00-rgM8eeTz5iJri-', NULL, NULL, NULL, NULL, 1, '2014-08-20', '2014-08-20'),
(149, 2, 3, 'TINTE ALFAPARF MILANO', 'MÁXIMA COBERTURA Y MÁXIMO PODER ACLARANTE\r\nreflejos del siempre Más Luminosos, brillantes, Fieles y Naturales\r\n', 'img/products/2014-08-20-22-08-55-oUdmFizVpOqLI-', 'img/products/img-lista/2014-08-20-22-08-54-SMIj1eubTMvag-', 'img/products/img-lista/2014-08-20-22-08-55-NOZfPNbicpD6n-', NULL, NULL, 1, '2014-08-20', '2014-08-20'),
(150, 2, 3, 'TINTE ALFAPARF  COLOR WEAR', '(tinte) Coloracion tono sobre tono sin Amoniaco', 'img/products/2014-08-20-22-08-35-jPHAyqIJvlsAW-', 'img/products/img-lista/2014-08-20-22-08-35-BzqLHxM99ktbL-', NULL, NULL, NULL, 1, '2014-08-20', '2014-08-20'),
(151, 2, 3, 'SHAMPOO SEMI DI LINO DIAMANTE ILLUMINATING', 'Las texturas multisensoriales, a base de Extracto de Semillas de Lino, Vitamina E, Omega-3 y Omega-6, favorecen la cohesión de las cutículas, aportando al cabello una suavidad y brillo únicos.', 'img/products/2014-08-20-22-08-56-ASW2X3qwY5ybl-', 'img/products/img-lista/2014-08-20-22-08-56-MCHAU5B2SAT1b-', NULL, NULL, NULL, 1, '2014-08-20', '2014-08-20'),
(152, 2, 3, 'SHAMPOO MIDOLLO DI BAMBOO', 'repara los daños más profundos regenerando la materia interna del cabello  devolviendo su  vigor, vitalidad y flexibilidad.', 'img/products/2014-08-22-20-08-42-WWITtPuT6iuZY-', NULL, NULL, NULL, NULL, 1, '2014-08-22', '2014-08-22'),
(153, 2, 3, 'KIT MIDOLLO DI BAMBOO ', 'Tratamiento Reestructurar para cabellos demasiado maltratado ', 'img/products/2014-08-22-20-08-08-kXsaFKwITBsyb-', 'img/products/img-lista/2014-08-22-20-08-08-CAlF39vUkuIAc-', NULL, NULL, NULL, 1, '2014-08-22', '2014-08-22'),
(154, 2, 3, 'KIT CIOCCOLATO', 'Cioccolato es la nutrición esencial para el cabello muy seco y quebradizo. Un tratamiento completo a base de los beneficios del chocolate que recupera la salud del cabello con una deliciosa fragancia, extremamente hidratante, luminoso y suave', 'img/products/2014-08-22-20-08-10-j6SEUQiho9EHQ-', NULL, NULL, NULL, NULL, 1, '2014-08-22', '2014-08-22'),
(155, 2, 3, 'SHAMPOO CIOCCOLATO', 'Shampoo suave de limpieza profunda. Ideal para recuperar la salud y el brillo de los cabellos quebradizos.', 'img/products/2014-08-22-21-08-59-qwQtBuuTCFLUn-', NULL, NULL, NULL, NULL, 1, '2014-08-22', '2014-08-22'),
(156, 2, 3, 'AMPOLLAS DIAMANTE SEMI DÍ LINO ALFAPARF AZUL Y ROSADA', 'Tratamiento intensivo cierra la cutícula dando al cabello luminosidad y suavidad, aporta al cabello cuerpo, elasticidad y un gran brillo', 'img/products/2014-08-22-21-08-22-5LGRaCIzzgXQq-', 'img/products/img-lista/2014-08-22-21-08-22-jaSuDnhji0LMG-', 'img/products/img-lista/2014-08-22-21-08-22-NQDT6YcNGxveP-', NULL, NULL, 1, '2014-08-22', '2014-08-22'),
(157, 2, 3, 'AMPOLLAS DIAMANTE SEMI DÍ LINO ALFAPARF AZUL Y ROSADA', 'Tratamiento intensivo cierra la cutícula dando al cabello luminosidad y suavidad, aporta al cabello cuerpo, elasticidad y un gran brillo', 'img/products/2014-08-22-21-08-15-aPVHdhlZsPB7z-', 'img/products/img-lista/2014-08-22-21-08-15-vMw5vqyTq4jhg-', 'img/products/img-lista/2014-08-22-21-08-15-TyCShrRwc0Oh3-', NULL, NULL, 1, '2014-08-22', '2014-08-22'),
(158, 1, 11, 'AGV K3 THE DONKEY', 'El K-3 es uno de los clásicos más vendidos cascos de AGV. Su diseño deriva de la parte superior de la gama GP-Tech cascos, con lo que la mayoría de las últimas características avanzadas para este producto con un precio razonable. El casco de inspiración-line carrera maximiza el flujo de aire minimizando los niveles de ruido, mientras que el alerón de nuevo asegura la estabilidad a altas velocidades. El sistema de ventilación dispone de tres tomas frontales, y seis extractores posteriores y laterales, mientras que un protector de viento barbilla evitar turbulencias en el interior del casco. El K-3 está disponible en una increíble gama de colores , incluyendo los gráficos oficiales Valentino Rossi réplica , que se pueden personalizar con adicionales Viseras , en Polarizados , Iridium y arco iris de colores. Si usted desea actualizar a una más ligera y más resistente de fibra de vidrio cubierta exterior del K-4 EVO sería el yelmo de la elección.', 'img/products/2014-08-23-15-08-32-UNa97RbHXiWHK-', 'img/products/img-lista/2014-08-23-15-08-32-tFyki0XAyd8eF-', 'img/products/img-lista/2014-08-23-15-08-32-6ftxl0hj7MbiR-', NULL, NULL, 1, '2014-08-23', '2014-08-23'),
(159, 1, 11, 'AGV K3 ROSSI ICON', 'El K-3 es uno de los clásicos más vendidos cascos de AGV. Su diseño deriva de la parte superior de la gama GP-Tech cascos, con lo que la mayoría de las últimas características avanzadas para este producto con un precio razonable. El casco de inspiración-line carrera maximiza el flujo de aire minimizando los niveles de ruido, mientras que el alerón de nuevo asegura la estabilidad a altas velocidades. El sistema de ventilación dispone de tres tomas frontales, y seis extractores posteriores y laterales, mientras que un protector de viento barbilla evitar turbulencias en el interior del casco.\r\n\r\nEl K-3 está disponible en una increíble gama de colores , incluyendo los gráficos oficiales Valentino Rossi réplica , que se pueden personalizar con adicionales Viseras , en Polarizados , Iridium y arco iris de colores.\r\n\r\nCon el fin de actualizar a una más ligera y más resistente compuesto de fibra de cáscara externa puede buscar la AGV K-4 EVO ', 'img/products/2014-08-23-15-08-07-9gP63UfOLKZ6m-', 'img/products/img-lista/2014-08-23-15-08-07-0XbpDF6JDilsu-', 'img/products/img-lista/2014-08-23-15-08-07-WxgubQHDXGbZ1-', NULL, NULL, 1, '2014-08-23', '2014-08-23');
...
CREATE TABLE IF NOT EXISTS `subcategorias` (
  ...
  UNIQUE KEY `id_2` (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=21 ;
...
(9, 'empresa1', 'empresa1@gmail.com', 'img/users/2014-04-07-16-falcao.jpg', '$2y$10$ZAVBQVPLMsyqEMKqfpaFWeRbwpMMUk2nuWjJ4LW7id09taURy7Ckq', '', '', 2, 0, 1, 'Mp4A33Z1bqOtYbARKHsIHzw2wRJD16XPtRUz7Gkiz6SFPvytMQLyzfvPOFEX', '2014-04-07 21:56:35', '2014-08-20 08:33:13'),
...
(33, 'soni', 'soni325@hotmail.com', 'img/users/2014-06-07-15-JRvXZ9p71npOi-barca.jpg', '$2y$10$hPMxpwQ9pQAMZyTnvrYs3.qG64p98/gJsQassMUrjaz5BFy2PmOoO', '', '', 1, 1, 1, 'FtNaOFpRSrdM5BmKXA7cfYa1rddQ3P0TvM9Bf30R4NpETfhuGYWDUF7uhhXv', '2014-06-07 20:27:05', '2014-08-24 06:48:21'),
...
(39, 'bandslam', 'ederalvarez2091057@gmail.com', 'img/users/', '$2y$10$2ae5bBc2XNa5wx3V5F57/O8xEmZzdvZ1nAi1qaDr1XHJs2/GaSJ1.', '', '', 2, 0, 1, 'oioWsXkHOKghBHXNQAAQ4VKiXHHdecr84W6jJJBAbQBEjL25WyMb8B8Cj5CG', '2014-07-25 02:17:45', '2014-08-20 03:24:31'),
...
(42, 'gio921', 'geoval-123@hotmail.com', 'img/users/', '$2y$10$tKrnoMKwyAGkHMx0z3UctOyaB7z558islKL2AFywY45Z6Di5V72lS', '', '', 1, 0, 1, 'xaBDHYZWLlp7Sn1oYIjQe9eIh7mhW2wEWYwU7adSkJQSHhWGknUVEKfck5rm', '2014-07-30 10:53:32', '2014-08-19 21:08:43'),
...
(52, 'moda-hombres', 'modahombres72@gmail.com', 'img/users/', '$2y$10$/P4oP28/nmA2sUS4h9MPzenqfz5TORy9VyTu7MnqA.jmVr7zLlXfC', '', '', 2, 1, 1, 'oR4JoIIRh5hYLWOap6xOhRBTVksxYmAVjBSwFqdE58xjA8yx89GrrUNcKYOG', '2014-08-06 01:10:50', '2014-08-20 04:18:00'),
...
(55, 'Mega tecno', 'tecnomegalopolis@gmail.com', 'img/users/', '$2y$10$/Gqcvnxc7uZix.OQGWrf3.Vw3Sqf3SxAr9d4QeRei.dtyKZqyZSCy', '', '', 2, 0, 1, 'n4M0Yn8f9d38v2p6VelgFSYHBEG5D0JSHHRwCcIA4aWCCPocERmsmHyJBBML', '2014-08-11 02:17:48', '2014-08-20 08:33:39'),
...
CREATE TABLE IF NOT EXISTS `user_favoritos` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=195 ;
...
CREATE TABLE IF NOT EXISTS `user_subs` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=77 ;
...
(75, 30, 29, NULL, NULL, '2014-08-23', '2014-08-23'),

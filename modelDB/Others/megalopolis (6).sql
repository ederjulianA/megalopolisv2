...
--
-- Servidor: localhost
-- Tiempo de generación: 16-05-2014 a las 21:03:40
...
(15, 13, 3, 3, 6, 'creaciones maya test', 'MayaTest', 'empresa de confecciones maya test', 'empresa de confecciones maya testempresa de confecciones maya testempresa de confecciones maya testempresa de confecciones maya test and bla', 'ave. las americas # 113-85 ', '2887765', 'img/empresas/2014-04-30-21-h2yCUjkB7tFiX-maya.JPG', '2014-05-01 02:53:58', '2014-05-14 02:09:35', NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `preguntas` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=22 ;
...
(18, 3, 5, 'Especial', 'Plato muy especiall para ocasiones unicas', 'img/products/2014-05-14-15-QJEYDwniJIekZ-demiValentine.jpg', '2014-05-14', '2014-05-14'),
(19, 4, 8, 'iphone 5s', 'Este es la ultima version del telefono de apple con grandes novedades en su sistema.', 'img/products/2014-05-16-20-BfBmH5KNzwBhJ-iphone.jpg', '2014-05-16', '2014-05-16'),
(20, 4, 7, 'Imac retina', 'El nuevo imac con pantalla retina, las imagenes cobran vida', 'img/products/2014-05-16-20-4r6Zp9pbzChaA-imac.jpg', '2014-05-16', '2014-05-16');
...
INSERT INTO `promociones` (`id`, `sede_id`, `categoria_id`, `titulo`, `titulo_seo`, `sin_descuento`, `con_descuento`, `porcentaje`, `descripcion_corta`, `descripcion_larga`, `estado`, `img`, `created_at`, `updated_at`) VALUES
(1, 1, 3, 'Hamburguesa especial', 'Hamburguesa-especial', 18000, 14000, 22, 'Promocion especial en nuestra mercagan junior', 'Aqui se espesifican las condiciones y restricciones de la promocion', 1, 'img/promociones/promo1.jpg', '2014-05-02', '2014-05-02'),
(2, 1, 3, 'perro loco', 'perro-loco', NULL, NULL, NULL, 'Promo perro caliente', 'Aqui la descripcion, condiciones y restricciones de la promocion', 1, 'img/promociones/promo2.jpg', '2014-05-02', '2014-05-02'),
(3, 3, 3, 'Pollo barato', 'pollo-barato', NULL, NULL, NULL, 'desc corta del pollo barato', 'desc largadesc largadesc largadesc larga', 0, 'img/promociones/2014-05-02-23-sqqKhk3qI8hip-promo3.jpg', '2014-05-02', '2014-05-02'),
(4, 4, 1, 'Mega Bestido', 'Mega-bestido', NULL, NULL, NULL, 'Ultimas unidades no te los pierdas', 'Esta es la descripcion larga de la promo del bestido', 0, 'img/promociones/2014-05-03-02-N8wRItihaVuhC-ropa.jpg', '2014-05-03', '2014-05-03'),
(5, 6, 1, 'promo1', 'promo1', NULL, NULL, NULL, 'desc breve', 'desc larga', 0, 'img/promociones/2014-05-03-03-8WMxuCma8TUOE-maya.JPG', '2014-05-03', '2014-05-03'),
(6, 3, 2, 'collar', 'collar', NULL, NULL, NULL, 'lindo collar ', 'esta en promocion por muy poco tiempo', 0, 'img/promociones/2014-05-03-23-hAn1D92zHOSzH-maya.JPG', '2014-05-03', '2014-05-03'),
(7, 10, 1, 'falta roja -50%', 'falda-roja', NULL, NULL, NULL, 'Para nuestros primeros clientes', 'esta falda estara disponible por poco tiempo', 0, 'img/promociones/2014-05-13-20-J2KEi7Ee9pPD1-roja.jpg', '2014-05-13', '2014-05-13'),
(8, 8, 3, 'pizza buena', 'piza-buena', 34900, 26000, 26, 'esta pizza es de calidad muy buena', 'para acceder a la promocion el usuario debe cumplir lo siguiente.', 0, 'img/promociones/2014-05-15-18-wzQPsp4AhFdXH-pizza.jpg', '2014-05-15', '2014-05-15'),
(9, 11, 4, 'Protector Iphone 5', 'protector-iphone-5', 58900, 25000, 58, 'Protege tu iphone de golpes', 'Este lindo y muy util protector de iphone cuidara tu celular de golpes y posibles daños', 0, 'img/promociones/2014-05-16-20-gMD2B1Oe1Bitx-protector.jpg', '2014-05-16', '2014-05-16');
...
(8, 'ederjulianA', 'ederalvarez2009@hotmail.com', 'img/users/2014-04-06-22-1080p-barcelona-team-2013-hd-wallpapers-4584.jpg', '$2y$10$3GJrbO6Dnr7tQfLImRhzo.mkdAmCwchMxpn5InOGM7mjv64tkERJu', '', '', 2, 1, 'IK2D2IG0RqVKRsi3OBVFkHnTOWv0SRIlDUPpRzYZC7URnp1q90dBPsUT2VW3', '2014-04-07 03:52:10', '2014-05-15 09:51:08'),
(9, 'empresa1', 'empresa1@gmail.com', 'img/users/2014-04-07-16-falcao.jpg', '$2y$10$ZAVBQVPLMsyqEMKqfpaFWeRbwpMMUk2nuWjJ4LW7id09taURy7Ckq', '', '', 2, 1, 'Dut2ATdBl5ey2L10L5nkpKxmrCeed9iS1lPk65v9aNER6AIfYkt8hFF6zYhU', '2014-04-07 21:56:35', '2014-05-14 20:09:03'),
...
(13, 'empresa10', 'empresa10@gmail.com', 'img/users/2014-04-12-19-falcao.jpg', '$2y$10$HKvlxMt8eH9IiV18SqEJJOhC/bQcqM8LEg6xX.fvRHNWOrEwiF/Ve', '', '', 2, 1, 'zUsQacSS80FliYJ1KLXreQgKsl67wz3Plun4gC5VXBkUuKcvwhR5ZkGD5oAx', '2014-04-13 00:01:01', '2014-05-14 02:23:01'),
...
CREATE TABLE IF NOT EXISTS `user_favoritos` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=122 ;
...
(120, 7, 13, '2014-05-16', '2014-05-16'),
...
(1, 7, 1, '0000-00-00', '0000-00-00'),
(2, 7, 2, '0000-00-00', '0000-00-00');

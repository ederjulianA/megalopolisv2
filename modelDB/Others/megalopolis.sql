...
--
-- Servidor: localhost
-- Tiempo de generación: 27-12-2014 a las 08:10:33
...
INSERT INTO `cart` (`id`, `id_user`, `id_empresa`, `total`, `num_items`, `created_at`, `updated_at`) VALUES
(1, 9, 31, 1899800, 2, '2014-12-15', '2014-12-15'),
(2, 9, 31, 1110000, 6, '2014-12-15', '2014-12-15');
...
CREATE TABLE IF NOT EXISTS `compra_items` (
  ...
  `image` varchar(250) COLLATE utf8mb4_spanish2_ci NOT NULL,
...
INSERT INTO `compra_items` (`id`, `compra_id`, `nombre`, `image`, `valor_unitario`, `valor_total`, `cantidad`, `id_producto`, `created_at`, `updated_at`) VALUES
(1, 1, 'Consola Playstation 4 500gb + 1 Control Dualshock 4 Original', 'img/products/2014-11-02-03-11-41-V29EbXfFhnMy1.jpg', 949900, 1899800, 2, 175, '2014-12-15', '2014-12-15'),
(2, 2, 'Watch Dogs Ps4 Español. Nuevo Y Sellado. Entrega Hoy Mismo!!', 'img/products/2014-08-01-08-bIDeANqBZzRVK-w1.jpg', 198000, 990000, 5, 73, '2014-12-15', '2014-12-15'),
(3, 2, 'Fifa 15 Ps4 Multilenguaje Español Latino Formato Físico', 'img/products/2014-11-02-03-11-00-81fC01V5QWF14.jpg', 120000, 120000, 1, 176, '2014-12-15', '2014-12-15');
...
CREATE TABLE IF NOT EXISTS `empresas` (
  ...
  `dir_mapa` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `empresas` (`id`, `user_id`, `sector_id`, `ciudad_id`, `barrio`, `razon_social`, `nombre_publico`, `desc_breve`, `desc_larga`, `direccion_principal`, `telefono`, `logo`, `banner`, `color_header`, `tema`, `color_tema`, `estado`, `created_at`, `updated_at`, `dir_mapa`, `latitude`, `longitude`) VALUES
(2, 9, 2, 2, 0, 'Jim Sports', 'jim-sports', 'Todo en artículos deportivos 																																																																														', 'Nos encontramos dedicados a la importación y comercialización de artículos deportivos 																																																																													', 'car 14 # 23-45', '6827000', 'img/empresas/2014-06-11-01-4W7nQHrTc170y-logo-jim-sports.jpg', 'img/empresas/banners/default/header.jpg', '#393E5C', 1, 3, 0, '2014-04-08 00:09:20', '2014-06-11 06:12:03', NULL, NULL, NULL),
(26, 39, 4, 2, 3, 'bandslam music bucaramanga', 'bandslam', '', 'pendiente', 'call 9 # 23-45', '6808965', 'img/empresas/2014-07-24-21-g5GwYYQm4ZRbF-logo-bandslam.jpg', 'img/empresas/banners2014-07-25-17-Y9qsonJA0xZ56-banner-bandslam.jpg', '#393E5C', 1, 3, 0, '2014-07-25 02:22:42', '2014-08-05 07:26:40', NULL, NULL, NULL),
(27, 40, 1, 2, 9, 'Teclados para pc', 'tecladospc', 'mi descripcion brave', 'mi descripcion larga', 'cll 22 n 21-34', '6322005', 'img/empresas/2014-07-25-13-PJQ1faoXMpblW-logo-tecladospc.jpg', 'img/empresas/banners/default/header.jpg', '#393E5C', 1, 3, 0, '2014-07-25 18:47:48', '2014-07-25 18:51:29', NULL, NULL, NULL),
(28, 43, 4, 2, 10, 'AURA MARIA MONCADA & CIA', 'LIBRERIA-AURA-MARIA-MONCADA', 'Comercialización y distribución de libros técnicos, de interés general y católicos', 'Comercializamos libros de todas las áreas del saber como administración, psicología, ingenierías, mercadotecnia, idiomas, además de libros de interés general y de autores católicos. Manejamos mas de 40 editoriales tanto en inglés como en español.', 'CL 36 29 - 29', '6454692 - 64554', 'img/empresas/2014-07-30-15-PiExpwV7v8T2d-logo-LIBRERIA-AURA-MARIA-MONCADA.jpg', 'img/empresas/banners2014-07-30-15-SfhJrfZMUteuP-banner-LIBRERIA-AURA-MARIA-MONCADA.jpg', '#393E5C', 1, 3, 1, '2014-07-30 20:32:52', '2014-07-30 20:42:04', NULL, NULL, NULL),
(29, 44, 2, 2, 10, 'SPORT CENTER CAB', 'SPORT-CENTER', '', 'MANEJAMOS MAS DE 15 MARCAS 100% ORIGINALES Y EXCLUSIVAS ACCESORIOS COMO GAFAS BOLSOS BILLETERAS GORRAS! OAKLEY, DIESEL,CALVIN KLEIN,HUGO BOSS, SPERRY, LACOSTE, LE COQ SPORTIF, CATERPILLAR Y MUCHAS MAS! \r\n', 'C COMERCIAL CABECERA IV ETAPA LOCAL 301-2', '6960986', 'img/empresas/2014-07-30-16-0dPYzXL0IPIk8-logo-SPORT-CENTER.jpg', 'img/empresas/banners2014-08-15-00-08-25-AWKTl7gNbNera-banner-SPORT-CENTER.jpg', '#393E5C', 1, 3, 1, '2014-07-30 21:52:22', '2014-09-12 03:18:15', NULL, NULL, NULL),
(30, 45, 4, 2, 9, 'AGROFARBEF LTDA', 'AGROFARBEF', 'Herramientas y maquinaria para la industria, construcción, metalmecanica, carpinteria y mineria', 'Es una empresa dedicada a la comercialización  de herramientas y maquinarias para la construcción, industria, metalmecanica, carpintería, y minería con un portafolio de productos amplio y con marcas reconocidas  lo cual nos diferencia de nuestros principales competidores, y con instalaciones cómodas que facilita el acceso a parqueadero y ubicado en un prestigioso lugar de la ciudad.', 'carrera 26 # 29-04 Antonia Santos', '6305401', 'img/empresas/2014-07-31-20-1lk5DY7SfhRCQ-logo-AGROFARBEF.jpg', 'img/empresas/banners2014-07-31-20-G6ZHI153Nr8fq-banner-AGROFARBEF.jpg', '#393E5C', 1, 3, 1, '2014-08-01 01:35:05', '2014-08-01 01:55:22', NULL, NULL, NULL),
(31, 8, 1, 1, 1, 'mundo xbox', 'mundo-xbox', '', 'Empresa dedicada a la comercializan de videojuegos de ultima generación.', 'pendiente', '6345678', 'img/empresas/2014-11-02-03-11-38-PPxObTA0lXI1n-logo-mundo-xbox.jpg', 'img/empresas/banners2014-11-04-23-11-35-Nuj8bpOxcrawE-banner-mundo-xbox.jpg', '#666', 1, 4, 1, '2014-08-01 13:12:13', '2014-11-19 01:17:31', NULL, NULL, NULL),
(32, 47, 4, 2, 4, 'Centro de Estética y Bienestar Stetik- Line', 'Stetik-Line', '', 'Tratamientos de embellecimiento facial, corporal, bienestar, reducción de medidas, asesoramiento nutricional y relajación.', 'CL 20 # 24 - 27 APTO 802', '3178243878 ', 'img/empresas/2014-08-02-02-VIQrrefqlZBh0-logo-Stetik-Line.jpg', 'img/empresas/banners2014-08-02-03-cPrn2gcpbojNK-banner-Stetik-Line.jpg', '#393E5C', 1, 1, 1, '2014-08-02 07:42:11', '2014-08-05 08:23:12', NULL, NULL, NULL),
(33, 48, 0, 2, 0, 'Nutritotal Coach', 'Nutritotal-Coach', '', 'Somos un grupo de Profesionales del Sector Salud capacitadas en la ejecución de actividades de prevención, promoción, fomento,protección y recuperación de la salud y de rehabilitación de personas enfermas\r\nEspecialista en Seguridad Alimentaría, Consulta y valoración nutricional personalizada, especificación de régimen dietario, apoyo en selección de alimentos, verificación en compras, técnicas de preparación saludables, plan de acondicionamiento físico todo totalmente personalizado. Tener el estado físico que mereces no es un milagro es un compromiso y una meta', 'Carrera 17 58-15 Barrio Ricaute', '3138380406', 'img/empresas/2014-08-04-16-08-06-I8LKAqaQPgAQG-logo-Nutritotal-Coach.jpg', 'img/empresas/banners/default/header.jpg', '#393E5C', 1, 3, 1, '2014-08-04 21:43:06', '2014-08-04 21:43:06', NULL, NULL, NULL),
(34, 49, 0, 2, 0, 'ACADEMIA DE ESTUDIOS TECNICOS EN SEGURIDAD LTDA', 'ACADEMIA-DE-SEGURIDAD-ATS', '', 'Promover la enseñanza de la seguridad integral fundamentada en el concepto actual y aplicable de la vigilancia y seguridad privada, con énfasis en la responsabilidad, equidad, tolerancia y valores éticos como pilares de la formación del hombre de seguridad', 'CRA 30 N 30a-05 barrio La Aurora', '-7- 6350050', 'img/empresas/2014-08-04-20-08-50-Ya7GCDZiOmyU5-logo-ACADEMIA-DE-SEGURIDAD-ATS.jpg', 'img/empresas/banners/default/header.jpg', '#393E5C', 1, 3, 1, '2014-08-05 01:40:50', '2014-08-05 01:40:50', NULL, NULL, NULL),
(35, 51, 0, 2, 0, 'Sentio Solvo', 'Senti-Solvo', '', 'Sentio Solvo es el nuevo concepto de moda, originalidad y libertad. Somos distinción y evolución basados en un estilo autónomo y contemporáneo.', 'Carrera 35 # 52-28 ', '6-960305', 'img/empresas/2014-08-05-16-08-03-MJ2riclp6atAL-logo-Senti-Solvo.jpg', 'img/empresas/banners2014-08-05-16-08-33-7cofbyNR3fI13-banner-Senti-Solvo.jpg', '#393E5C', 1, 3, 1, '2014-08-05 21:33:03', '2014-08-05 21:46:33', NULL, NULL, NULL),
(36, 52, 0, 2, 0, 'Gorra Ripley LTDA', 'gorras-ripley', '', 'Somos una empresa dedicada a comercializar gorras juveniles de todos los estilos, de diferentes marcas.', 'Carrera 21 # 21-45', '6481166', 'img/empresas/2014-08-05-20-08-22-YP7xLU7KoYEJ1-logo-Gorras-Ripley.jpg', 'img/empresas/banners2014-08-19-22-08-12-Nu98fW34jVG7l-banner-Gorras-Ripley.jpg', '#393E5C', 1, 3, 0, '2014-08-06 01:28:22', '2014-08-20 03:34:12', NULL, NULL, NULL),
(37, 53, 0, 2, 0, 'sonata bucaramanga', 'musicales-sonata', '', 'venta  de  instrumentos  musicales   ,  de  primera  y  de   segunda en   buen  estado,,marcas   hohner gibson, yamaha, fender, takamine, mapez, dw, gigraltar ,epiphone , shure, zildjian  y  más.   ademas   relizamos   toda  clase  de  mantenimientos   incluyendo   de    sonido.', 'carrera  23  n   35   66   local   205', '6320192  645891', 'img/empresas/2014-08-06-20-08-01-rVAEDW6fouv7Z-logo-musicales-sonata.jpg', 'img/empresas/banners/default/header.jpg', '#393E5C', 1, 3, 1, '2014-08-07 01:28:01', '2014-08-07 01:28:01', NULL, NULL, NULL),
(38, 54, 0, 2, 0, 'Ropa femenina Kiut', 'Ropa-femenina-Kiut', '', 'Somos una empresa dedicada a la venta de ropa del mejor estilo para público femenino. Nos caracterizamos por marcar tendencia y estar a la vanguardia de la moda actual.', 'Calle 20 # 19 - 19', '6481166', 'img/empresas/2014-08-09-17-08-55-TsyjbhBwoFWAJ-logo-Ropa-femenina-Kiut.jpg', 'img/empresas/banners2014-08-10-18-08-02-gdMtzTVD0E4nP-banner-Ropa-femenina-Kiut.jpg', '#393E5C', 1, 3, 1, '2014-08-09 22:10:55', '2014-08-10 23:03:02', NULL, NULL, NULL),
(44, 55, 0, 2, 0, 'Tecnópolis', 'Mobile-Shop', '', 'Nos dedicamos a la comercialización de artículos tecnológicos como relojes digitales, smartphones, tablets, etc.', 'Calle 35 # 24-17', '3152175967', 'img/empresas/2014-08-11-17-08-32-GarNobVucQPIk-logo-Mobile-Shop.jpg', 'img/empresas/banners2014-08-11-17-08-04-FDoEbn6Shek1c-banner-Mobile-Shop.jpg', '#393E5C', 1, 3, 1, '2014-08-11 22:04:32', '2014-08-15 02:22:44', NULL, NULL, NULL),
(45, 59, 0, 2, 0, 'La Pasteleria', 'La-Pasteleria', '', 'Venta de Cupcakes, Tortas y ponques. Llegamos a la puerta de tu casa con nuestro producto.', 'Calle 61 no 7 w 44', '3163399147', 'img/empresas/2014-08-14-00-08-40-3Nv5Y5Lj9BmQH-logo-La-Pasteleria.jpg', 'img/empresas/banners2014-08-14-00-08-48-QnEaZOBjCwwoq-banner-La-Pasteleria.jpg', '#393E5C', 1, 3, 1, '2014-08-14 05:45:40', '2014-08-14 05:54:48', NULL, NULL, NULL),
(46, 60, 0, 2, 0, 'GRUPO TODOOPTICA.', 'Todoptica', '', 'Empresa dedicada a la salud visual, prevención y tratamiento de defectos visuales y patologías oculares, consultoría y asesoría, con productos asequibles de excelente calidad y precios cómodos para todo tipo de clientes.', 'Cra. 33 # 41-24 Cabecera.', '3133251086', 'img/empresas/2014-08-28-16-08-02-Yvnu3Z7tWitPG-logo-Todoptica.jpg', 'img/empresas/banners2014-08-14-21-08-48-ANXekLmpJ3DMe-banner-Todoptica.jpg', '#393E5C', 1, 3, 1, '2014-08-15 02:32:28', '2014-08-28 21:29:06', NULL, NULL, NULL),
(47, 61, 0, 2, 0, 'BELCO S.A.S', 'BELCO', '', 'Venta y Distribución de productos de belleza, tales como alfaparf milano, Recamier,Igora Royal , Lemar, Maxibel,Masglo, entre otros ', 'CARRERA 33 # 41-10', '3214286967- 300', 'img/empresas/2014-08-16-20-08-55-HNOJvPCqM7yJF-logo-BELCO.jpg', 'img/empresas/banners2014-08-16-20-08-18-pnJz5KqdQQk6u-banner-BELCO.jpg', '#393E5C', 1, 3, 1, '2014-08-17 01:26:28', '2014-08-17 01:31:18', NULL, NULL, NULL),
...
(49, 31, 0, 0, 0, 'MiCarrito', 'MiCarrito', '', 'esta es mi empresa', 'cll 22 n 21-37', '6322005', 'img/empresas/2014-09-11-16-09-49-VxMZ10SRQJ4TS-logo-MiCarrito.jpg', 'img/empresas/banners/default/header.jpg', '#393E5C', 1, 3, 0, '2014-09-11 21:13:49', '2014-09-11 21:13:49', NULL, NULL, NULL),
(50, 71, 0, 2, 0, 'DaleDetalles', 'DaleDetalles', '', 'Dale detalles a las personas que quieres, vamos hoy es el momento', 'Cll 22 n 21 37', '3015673205', 'img/empresas/2014-11-05-13-11-56-ghARrKp6F0whn-logo-DaleDetalles.jpg', 'img/empresas/banners2014-11-05-13-11-47-CnVSwUFyugqim-banner-DaleDetalles.jpg', '#393E5C', 1, 3, 1, '2014-11-05 18:38:56', '2014-11-05 18:51:47', NULL, NULL, NULL),
(51, 72, 0, 2, 0, 'La Vuelta', 'La-Vuelta', '', 'Servicio de soluciones financieras, desembolsamos dinero una hora, casas apartamentos sin tanto problema, soluciones educativas, becas de estudio, becas trabajo, título bachiller único requisito la cédula, subsidios universitarios, eliminación reportes centrales de riesgo.', 'Calle 16 # 11-58', '6712460 310 886', 'img/empresas/2014-12-12-14-12-37-TRAytNcQ8MSq1-logo-La-Vuelta.jpg', 'img/empresas/banners/default/header.jpg', '#393E5C', 1, 3, 0, '2014-12-12 19:23:37', '2014-12-12 19:23:37', NULL, NULL, NULL);
...
(8, 9, 2, 'Eder', 'Julian', NULL, 'calle 17 #3w-65 miraflores torre 36 apto 11-37', 'miraflores  hhyubv', '3013119198', '2014-10-30', '2014-12-15');
...
(9, 'empresa1', 'ederalvarez2091057@gmail.com', 'img/users/2014-04-07-16-falcao.jpg', '$2y$10$ZAVBQVPLMsyqEMKqfpaFWeRbwpMMUk2nuWjJ4LW7id09taURy7Ckq', '', '', 2, 0, 1, 'rAhFwf1JYl5xGJwuITDZsm29INDBYbc4FS0nfVxF8wPL4fGl1ZKrFEY8YGhS', '2014-04-07 21:56:35', '2014-12-17 21:07:16'),
...
(70, 'camila95', 'camiladiaz1255@outlook.com', 'img/users/', '$2y$10$VbaTJ4.vvMqNyuivFD.I3OtZO6zJtIhmarJ1KMW/Vzelj.T4gXvT2', '', '', 1, 0, 1, 'IsAu3gMa2SZpHCATdF73oYdAJBnIryfawiWeNqotD8xHNbMrJbSRLTjE4Dti', '2014-09-01 08:37:26', '2014-12-15 03:13:50'),
...
(72, 'JuanCarlos', 'wendymel_0327@hotmail.com', 'img/users/', '$2y$10$YdlqcaWCHOcvK4uVNcAIQO/vyLc0z0hiQJrH6.DbnecB6osdyyznS', '', '', 2, 0, 1, '', '2014-12-12 19:09:51', '2014-12-12 19:11:09');
...
CREATE TABLE IF NOT EXISTS `user_favoritos` (
  ...
  `updated_at` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci AUTO_INCREMENT=207 ;
...
(206, 70, 176, '2014-12-11', '2014-12-11');

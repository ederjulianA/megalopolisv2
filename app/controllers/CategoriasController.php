...
class CategoriasController  extends BaseController {
	...
	public function getSubCategorias($id, $id_sub)
	{
		...
		->select('a.precio_detal',
				 ...
				 's.telefono',
				 'sc.nombre_sub'
			 )->where('p.subcat_id','=',$id_sub)->where('p.estado','=',1)->where('e.estado','=','1')->paginate(9);

		$numProductos = count($producto);

		return View::make('subcategorias')->with('categorias',$categorias)->with('cat',$cat)->with('numPro',$numProductos)->with('productos',$producto);	
	}

            ...
            <li class="megamenu-content "> 
              ...
              <ul class="col-lg-3  col-sm-3 col-md-3  col-xs-4">
                <li>
                    ...
                    <img class="img-responsive" src="Tshop/images/site/promo1.jpg" alt="product"> 
              ...
              <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                <li>
                	<a class="newProductMenuBlock" href="product-details.html"> 
                    <img class="img-responsive" src="Tshop/images/site/promo2.jpg" alt="product"> 
              ...
              <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-4">
                <li>
                    <a class="newProductMenuBlock" href="product-details.html"> 
                        <img class="img-responsive" src="Tshop/images/site/promo3.jpg" alt="product">
            ...
            <li class="megamenu-content"> 
              ...
              <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                <li class="no-margin productPopItem "> 
                    ...
                    <img class="img-responsive" src="Tshop/images/site/g4.jpg" alt="img"> 
                    </a> 
              ...
              <ul class="col-lg-3  col-sm-3 col-md-3 col-xs-6">
                <li class="no-margin productPopItem relative">
                 <a href="product-details.html"> 
                 <img class="img-responsive" src="Tshop/images/site/g5.jpg" alt="img"> 
                 </a> 
                <a class="text-center productInfo alpha90" href="product-details.html"> Eodem modo typi <br>
                  <span> $60 </span> </a> </li>
              </ul>
...
<div class="container main-container headerOffset">
  ...
  <div id="SimilarProductSlider">
      <div class="item">
        <div class="product"> <a class="product-image" > <img src="Tshop/images/product/a1.jpg"  alt="img"> </a>
      ...
      <div class="item">
        <div class="product"> <a class="product-image" > <img src="Tshop/images/product/a2.jpg"  alt="img"> </a>
          <div class="description">
      ...
      <div class="item">
        <div class="product"> <a class="product-image" > <img src="Tshop/images/product/a3.jpg" alt="img"> </a>
          <div class="description">
      ...
      <div class="item">
        <div class="product"> <a class="product-image" > <img src="Tshop/images/product/a4.jpg"  alt="img"> </a>
          <div class="description">

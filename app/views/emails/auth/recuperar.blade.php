...
<title>Email de Activacion</title>
		...
		<tr align="center">
			<td>	
				<table bgcolor="#fafafa" align="center" width="600" style="padding:15px 0; border-bottom: 1px solid #eee;">
					<tbody>
						<tr align="center">
							<td style="font:22px Arial, Helvetica, sans-serif;" class="skin-font"> Hola {{$username }} </td>
						</tr>
						<tr align="center" style="padding-top: 10px;">
							<td style="font:12px Arial, Helvetica, sans-serif; padding:10px 50px 10px;">
								Has solicitado un cambio de contraseña, Si no lo has hecho porfavor ignora este mensaje<br>
								...
								<h3>Para cambiar tu contraseña porfavor da click o copia y pega el siguiente link </h3>
								{{ $link }}

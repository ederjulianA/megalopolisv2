...
<body style="margin: 0;padding: 0;font-size: 20px;font-family: sans-serif;">
	...
	<div class="email-background" style="margin: 0;padding: 0;font-size: 20px;font-family: sans-serif;background-color: #fff;max-width: 100%;">
		...
		<div class="email-body" style="margin: 7% auto;padding: 20px;font-size: 20px;font-family: sans-serif;color: #666;max-width: 400px;text-align: left;">
			<h2 style="margin: 10px 10px 25px 15px;padding: 0;font-size: 20px;font-family: sans-serif;">Hola, <span class="span-user" style="margin: 0;padding: 0;font-size: 22px;font-family: sans-serif;color: #4ec67f;"></span></h2>
			<p style="margin: 10px;padding: 20px;font-size: 20px;font-family: sans-serif;width: 100%;">
				Hemos recibido una solicitud para cambiar tu contraseña de Megalópolis.
			</p>
			<p style="margin: 10px;padding: 20px;font-size: 20px;font-family: sans-serif;width: 100%;">
				<a href="{{ URL::to('password/reset', array($token)) }}" class="btn-cambias-pass" style="margin: 20px auto;padding: 15px;font-size: 20px;font-family: sans-serif;border: 2px solid #4ec67f;border-radius: 7px;color: #4ec67f;max-width: 100%;text-decoration: none;width: 50%;text-align: center !important;">Cambiar Contraseña</a>
			</p>

			<p style="margin: 10px;padding: 20px;font-size: 20px;font-family: sans-serif;width: 100%;">
				Si ignoras este mensaje, tu contraseña no se cambiará.
Si no has solicitado el cambio de contraseña, <a href="#" class="btn-info" style="margin: 0;padding: 0;font-size: 20px;font-family: sans-serif;">infórmanos.</a>
			</p>

		...
		<tr align="center">
			<td>	
				<table bgcolor="#fafafa" align="center" width="600" style="padding:15px 0; border-bottom: 1px solid #eee;">
					<tbody>
						<tr align="center">
							<td style="font:22px Arial, Helvetica, sans-serif;" class="skin-font"> Hola {{$empresa}} </td>
						</tr>
						<tr align="center" style="padding-top: 10px;">
							<td style="font:12px Arial, Helvetica, sans-serif; padding:10px 50px 10px;">
								Has vendido {{$producto}}, por favor comunícate con tu comprador para acordar los detalles finales de tu venta  .<br>
								<h3>Ingresa a tu tienda</h3>
								<br>
								Y administra tus ventas.
								 

								 <br><br>
								
								<h3>Puedes Hacerlo desde este link </h3>
								{{ $link }}

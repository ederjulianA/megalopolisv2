...
<title>Email de Suscripción</title>
									...
									<tbody>
										<tr>
											...
											<td align="left" valign="top" style="font:Bold 11px Arial, Helvetica, sans-serif;">
												<a href="{{URL::route('index')}}">Ver nuestra App </a>
											</td>
										</tr>
									</tbody>
								</table>
												...
												<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
													<tbody>
														<tr>
															...
															{{HTML::image('img/logo_2x.png','megalopolis', array('width'=>'150px'))}}
		...
		<tr align="center">
			<td>	
				<table bgcolor="#fafafa" align="center" width="600" style="padding:15px 0; border-bottom: 1px solid #eee;">
					<tbody>
						<tr align="center">
							<td style="font:22px Arial, Helvetica, sans-serif;" class="skin-font"> Hola  </td>
						</tr>
						<tr align="center" style="padding-top: 10px;">
							<td style="font:12px Arial, Helvetica, sans-serif; padding:10px 50px 10px;">
								Gracias {{$email}} Por suscribirte a la lista de correos de<br>
								<h3>Megalopolis</h3>
								<br>
								Por este medio, te notificaremos sobre todas las novedades de Megalopolis.

...
<head style="font-family: sans-serif Arial Verdana;font-size: 20px;margin: 0;padding: 0;">
	...
	<title style="font-family: sans-serif Arial Verdana;font-size: 20px;margin: 0;padding: 0;">Pregunta</title>
	...
	<div class="email-background" style="font-family: sans-serif Arial Verdana;font-size: 20px;margin: 0;padding: 0;background-color: #fff;max-width: 100%;width: 100%;height: 100%;">	
			<div class="email-container" style="font-family: sans-serif Arial Verdana;font-size: 20px;margin: 3% auto;padding: 5px;background-color: #fff;max-width: 600px;width: 100%;">
					<div class="email-header" style="font-family: sans-serif Arial Verdana;font-size: 20px;margin: 0;padding: 0;max-width: 100%;text-align: center;width: 100%;">
							<img src="{{asset('Tshop/emails/pregunta.jpg')}}" style="font-family: sans-serif Arial Verdana;font-size: 20px;margin: 0;padding: 0;max-width: 100%;width: 100%;">

						
					</div>
					<div class="email-body" style="font-family: sans-serif Arial Verdana;font-size: 20px;margin: 0;padding: 20px;max-width: 100%;">
						<h1 style="font-family: sans-serif Arial Verdana;font-size: 45px;margin: 0;padding: 0;color: #73B1E8;font-weight: bold;text-align: center;">Nueva Pregunta en Megalópolis</h1>
						...
						<p class="pregunta" style="font-family: sans-serif Arial Verdana;font-size: 25px;margin: 0;padding: 0;text-align: left;letter-spacing: 2px;color: #666;margin-top: 20px;">
							...
							Hola <span class="usuarioTag" style="font-family: sans-serif Arial Verdana;font-size: 30px;margin: 0;padding: 0;font-weight: bold;color: #73B1E8;">{{$username}}</span>, te han preguntado en megalópolis por el articulo <br style="font-family: sans-serif Arial Verdana;font-size: 20px;margin: 0;padding: 0;"><span class="articulo" style="font-family: sans-serif Arial Verdana;font-size: 30px;margin: 15px;padding: 0;font-weight: bold;color: #999;font-style: oblique;">"{{$pro_nombre}}"</span>.
						...
						<div class="responder" style="font-family: sans-serif Arial Verdana;font-size: 20px;margin: 15% auto;padding: 0;max-width: 100%;text-align: center;width: 100%;">
							<a href="{{$link}}" class="btn-responder" style="font-family: sans-serif Arial Verdana;font-size: 20px;margin: 0;padding: 10px;border-bottom: 4px solid #45739A;border-radius: 20px;color: #fff;text-shadow: 2px 1px 0px rgba(0,0,0,.5);max-width: 100%;text-decoration: none;background-color: #73B1E8;">Responder Preunta</a>

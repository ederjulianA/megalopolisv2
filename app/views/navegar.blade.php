			...
			<div class="row">
				<div class="col-sm-3">
					<div class="left-sidebar">
					  <div class="fon_col_cat" id="fondo_cat">
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#womens">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>Ropa de mujer</a>
									</h4>
								</div>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="#"> <span class="pull-right">(32)</span>pronto</a></li>
									<li><a href="#"> <span class="pull-right">(5)</span>etnies</a></li>
									<li><a href="#"> <span class="pull-right">(9)</span>clamp</a></li>
									<li><a href="#"> <span class="pull-right">(4)</span>op</a></li>
								</ul>
							</div>
						</div><!--/brands_products-->
						
						<div class="price-range"><!--price-range--></div><!--/price-range--><!--/shipping-->
               ...
               <div class="features_items"><!--features_items-->
					...
					<div class="category-tab"><!--category-tab--></div>
			  ...
			  </div><!--/category-tab--><!--/recommended_items-->

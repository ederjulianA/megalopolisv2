...
<div class="span3 product_list">
	<ul class="nav">
	   ...
	   <li class="span2">
          <div class="thumbnail">
            <a href="product.html"><img alt="" src="BSC/css/images/nexus-one-3-150x123.jpg" /></a>
            <div class="caption">
	   ...
	   <li class="span2">
          <div class="thumbnail">
            <a href="product.html"><img alt="" src="BSC/css/images/thumb_sam_3d.jpg" /></a>
            <div class="caption">
	   ...
	   <li class="span2">
          <div class="thumbnail">
            <a href="product.html"><img alt="" src="BSC/css/images/ipad_case.jpg" /></a>
            <div class="caption">
	   ...
	   <li class="span2">
          <div class="thumbnail">
            <a href="product.html"><img alt="" src="BSC/css/images/HMX-H104.JPG" /></a>
            <div class="caption">
	   ...
	   <li class="span2">
          <div class="thumbnail">
            <a href="product.html"><img alt="" src="BSC/css/images/expic.png" /></a>
            <div class="caption">

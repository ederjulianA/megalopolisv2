...
<div class="navbar navbar-fixed-top bs-docs-nav" role="banner">
    ...
    <div class="conjtainer">
      ...
      <div class="navbar-header">
		  ...
		  <a href="/adminpanel" class="navbar-brand hidden-lg">@yield('name_company')</a>
		</div>
        ...
        <ul class="nav navbar-nav pull-right">
          <li class="dropdown pull-right">            
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="{{URL::route('cerrar-sesion')}}"><i class="fa fa-sign-out"></i> Logout</a></li>
            </ul>
          </li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <!-- Logo. -->
          <div class="logo">
            <h1><a href="#"><span class="bold">@yield('name_company')</span></a></h1>
...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class="open"><a href="/adminpanel"><i class="fa fa-tag"></i> Dashboard</a>
            <!-- Sub menu markup 
            <ul>
       ...
       <a href="#"><i class="fa fa-list-alt"></i> Productos  <span class="pull-right"><i class="fa fa-tags"></i></span></a>
            <ul>
              ...
              <li class="has_sub"><a href="#"><i class="fa fa-bar-chart-o"></i> Personalizar</a>
                   <ul>
              <li><a href="{{ URL::route('adminpanel-logo')}}">Logo</a></li>
              <li><a href="{{ URL::route('adminpanel-tema')}}">Plantilla</a></li>
...
<script type="text/javascript" src="{{asset('admin2/adminJS/time.js')}}"></script>
<script type="text/javascript" src="{{asset('admin2/adminJS/jquery.timeago.js')}}"></script>
@yield('scripts')

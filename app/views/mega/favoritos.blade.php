            ...
            @if($favoritos->count())
             ...
             <tr class="CartProduct" id="fav-{{$fav->id}}">
			                ...
			                <td style="width:40%"><div class="CartDescription">
			                    <h4> <a href="product-details.html">{{$fav->producto_nombre}} </a> </h4>
			                    <span class="size">{{$fav->categoria_nombre}}</span>
			                    <div class="price"> <span>${{$fav->precio_detal}}</span> </div>
			                  </div></td>
			                <td style="width:15%"><a class="btn btn-primary"> <span class="add2cart"><i class="glyphicon glyphicon-shopping-cart"> </i> Ver producto </span> </a></td>
